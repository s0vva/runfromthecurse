...
(function() {
    ...
    $(document).ready(function() {
        var links = [{
                name: "inject",
                link: "https://e-z.bio/art"
            },
            {
                name: "riasco",
                link: "https://feds.lol/pollmaker"
            },
            {
                name: "wiskas",
                link: ""
        ...
        if (window.mobileAndTabletCheck()) {
            $("#brand").replaceWith(
                '<span id="brand" style="margin-left:0.3pc;"></span>'
            );
...
document.addEventListener("DOMContentLoaded", function() {
    var gyatOverlay = document.getElementById('gyat-overlay');
    var content = document.getElementById('content');
    
    gyatOverlay.addEventListener('click', function() {
